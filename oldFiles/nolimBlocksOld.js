...
nolimBlocks.push({
    ...
    {
        "id": "10",
        "title": "+ Добавить дополнительный текст",
        "type": "groupInputs",
        "options": [
            {
                "title": "Текст",
    ...
    {
        "id": "12",
        "title": "+ Добавить стили при наведении",
        "type": "groupInputs",
        "options": [
            {
                "title": "Цвет текста",
    ...
    moddefaultsettings: '["","","","0px","","solid","","","100", ["","","","100"], [""], ["","","","solid",""],"","","","0px","","solid","",""]',
    modInputChange: function modcontentfunc() {
        ...
        if($('.noliminput[id="4"]').val() == '0px'){
            $('.noliminput[id="5"]').parents('.pe-form-group').hide();
            $('.noliminput[id="6"]').parents('.pe-form-group').hide();
            $('[id="group_groupInputs12"] .pe-form-group').eq(3).css('display', 'none');
            $('[id="group_groupInputs12"] .pe-form-group').eq(4).css('display', 'none');
        } else if($('.noliminput[id="4"]').val() != '0px'){
            $('.noliminput[id="5"]').parents('.pe-form-group').show();
            $('.noliminput[id="6"]').parents('.pe-form-group').show();
            $('[id="group_groupInputs12"] .pe-form-group').eq(3).css('display', 'block');
            $('[id="group_groupInputs12"] .pe-form-group').eq(4).css('display', 'block');
        }
    
        if($('.noliminput[id="15"]').val() == '0px'){
            $('.noliminput[id="16"]').parents('.pe-form-group').hide();
            $('.noliminput[id="17"]').parents('.pe-form-group').hide();
        } else if($('.noliminput[id="15"]').val() != '0px'){
            $('.noliminput[id="16"]').parents('.pe-form-group').show();
            $('.noliminput[id="17"]').parents('.pe-form-group').show();
        }
    ...
    <style>
        ${name[0]} .t-upwidget-container__button:not(.t-upwidget-container__button_fileholder) {
            ...
            border: ${name[3]} ${name[5]} ${name[4]} !important;
        }
    ...
    ${name[11][0] == '' ? '' : `
        ${name[0]} .t-upwidget-container__button:not(.t-upwidget-container__button_fileholder):hover {
            ...
            border: ${name[3]} ${name[11][3]} ${name[11][2]} !important;
        }
    `}
        ${name[0]} .t-upwidget-container__button {
            ...
            font-weight: ${name[8]} !important;
            border-radius: ${name[6]}px !important;
            border: ${name[15]} ${name[17]} ${name[16]} !important;
        }
    ${name[19] == '' ? '' : `
    ...
    ${name[10][0] == '' ? '' : `
        ${name[0]} .t-upwidget-container__button:not(.t-upwidget-container__button_fileholder):first-child:before {
            content: '';
            padding-right: 10px;
            right: 7px;
            top: 6px;
    ...
    `}
        ...
        ${name[0]} .t-uploadcare [data-status="ready"], [data-status="started"]{ background-color: ${name[2]}!important; } 
    
        ${name[0]} [data-status="loaded"] .uploadcare--widget__text { display: flex; padding: 0px!important; margin: 0px; } 
    
        ${name[0]} .uploadcare--widget { width: 100%; text-align: center; border-radius: ${name[6]}px!important; } 
    
        ${name[0]} [data-status="started"].uploadcare--widget{ padding: 20px 0; display: flex; color: ${name[1]}; justify-content: center; width: 100%; align-items: center; } 
    
        ${name[0]} [data-status="ready"] .uploadcare--widget__button.uploadcare--widget__button_type_open{ text-align: center; color: ${name[1]}; background-color: unset!important; display: block!important; font-size: ${name[7]}px!important; font-weight: ${name[8]}!important; border: ${name[3]} ${name[5]} ${name[4]}!important; width: 100%; border-radius: ${name[6]}px!important; line-height: 29px!important; padding: 12px 0 15px 0; cursor: pointer; outline: none; transition: none; }  
    ${name[11][0] == '' ? '' : `
        ${name[0]} [data-status="ready"] .uploadcare--widget__button.uploadcare--widget__button_type_open:hover { color: ${name[11][0]}!important; background-color: ${name[11][1]}!important; border: ${name[3]} ${name[11][3]} ${name[11][2]}!important; cursor: pointer; }   
    `}
    ${name[9][0] == '' ? '' : `
        ${name[0]} .t-uploadcare [data-status="ready"] .uploadcare--widget__button_type_open:after{ content: "${name[9][0]}"; display: block; white-space: normal; text-align: center; overflow: hidden; text-overflow: ellipsis; line-height: 100%!important; color: ${name[9][1]}!important; max-width: 100% !important; font-size: ${name[9][2]}px!important; font-weight: ${name[9][3]}!important; font-family:inherit; padding-top: 14px; }   
    
        ${name[0]} .t-uploadcare [data-status="ready"] .uploadcare--widget__button_type_open:hover:after{ content: "${name[9][0]}"; ${name[11][4] != '' ? `color: ${name[11][4]} !important;` : ''} } 
    `}
    ${name[10][0] == '' ? '' : `
        ${name[0]} [data-status="ready"] .uploadcare--widget__button.uploadcare--widget__button_type_open:before{ content: ''; padding-right: 10px; right: 7px; top: 6px; width: 24px; display: inline-block; z-index: 2; height: 24px; background-position: center; background-size: contain; background-repeat: no-repeat; background-image: url(${name[10][0]}); position: relative; }  
    `}
        ${name[0]} .t-uploadcare [data-status="loaded"]{ background-color: ${name[14]}!important; border: ${name[15]} ${name[17]} ${name[16]}; } 
    
        ${name[0]} .uploadcare--link, .uploadcare--link:link, .uploadcare--link:visited { display: flex; color: ${name[13]}; text-decoration: none; font-weight: ${name[8]}; font-size: ${name[7]}px!important; padding: 20px 0; width: 100%; justify-content: center; outline: none; }  
    ${name[19] == '' ? '' : `
        ${name[0]} [data-status="loaded"] .uploadcare--link.uploadcare--widget__file-name:after{ content: ""; width: 24px; display: inline-block; height: 24px; background-position: center; background-size: contain; background-repeat: no-repeat; background-image: url(${name[19]}); position: relative; margin-top: -3px; margin-left: 10px; }  
    `}
        ${name[0]} .uploadcare--widget__dragndrop-area{ color: ${name[1]}; background: ${name[2]}; z-index: 3; border-radius: ${name[6]}px!important; } 
    
        .uploadcare--dragging .uploadcare--widget__dragndrop-area { display: flex!important; align-items: center; justify-content: center; } 
    
        ${name[0]} .uploadcare--widget__file-size{ display: none; } 
    </style>
    ...
    nolimBlocks.push({
        ...
        modInputChange: function modcontentfunc() {
            ...
            $('[id="grouptitle_groupInputs4"]').hide();
            $('.noliminput[id="5"]').parents('.pe-form-group').hide();
            $('.noliminput[id="6"]').parents('.pe-form-group').hide();
        
            if($('.noliminput[id="2"]').val() == '0'){
                $('.noliminput[id="3"]').parents('.pe-form-group').hide();
                $('[nolim-group-id="groupInputs4"]').hide();
            } else {
                $('.noliminput[id="3"]').parents('.pe-form-group').show();
                $('[nolim-group-id="groupInputs4"]').show();
            }
        
            if($('[id="group_groupInputs4"] .nolimgroupinput').eq(2).val() == '0' && $('.noliminput[id="2"]').val() == '0'){
                $('.noliminput[id="5"]').parents('.pe-form-group').hide();
                $('.noliminput[id="6"]').parents('.pe-form-group').hide();
            } else if($('[id="group_groupInputs4"] .nolimgroupinput').eq(2).val() == '1' && $('.noliminput[id="2"]').val() == '1') {
                $('.noliminput[id="5"]').parents('.pe-form-group').show();
                $('.noliminput[id="6"]').parents('.pe-form-group').show();
            }
        },
        modoptions: [function modcontentfunc(nameCard) {
            ...
            for(let i = 0; i < nameCard.length; i++){
                if(nameCard[i][0] != ''){
                    linkCode += `
                    [name="${nameCard[i][0]}"]::placeholder { background-image: url(${nameCard[i][1]}); }
                    `;
                }
            }
            return linkCode
            ...
            for(let i = 0; i < name.length; i++){
                if(name[i][0] != ''){
                    ...
                    arrName.push(nameVal);
                }
            }; 
        
            return arrName.join(",");
        },function modcontentfunc(nameCard, name) {
            let linkCode = ``;
            ...
            for(let i = 0; i < nameCard.length; i++){
                if(nameCard[i][1] != ''){
                    linkCode += `
                    [name="${nameCard[i][0]}"] { 
                        background: url(${nameCard[i][1]}), linear-gradient(left, ${name}, ${name}); 
                        background: url(${nameCard[i][1]}), -webkit-linear-gradient(left, ${name}, ${name}); 
                        background: url(${nameCard[i][1]}), -moz-linear-gradient(left, ${name}, ${name}); 
                        background: url(${nameCard[i][1]}), -ms-linear-gradient(left, ${name}, ${name}); 
                        background: url(${nameCard[i][1]}), -o-linear-gradient(left, ${name}, ${name});  
                    }    
                    `;
                }
            }
            return linkCode
        },function modcontentfunc(nameCard, name3, name4, name5) {
            let linkCode = ``;
            ...
            for(let i = 0; i < nameCard.length; i++){
                if(nameCard[i][1] != ''){
                    linkCode += `
                    [name="${nameCard[i][0]}"] { 
                        background: url(${nameCard[i][1]}), linear-gradient(right, ${name3}, ${name3}), linear-gradient(right, ${name4}${name5 != '100' ? `${name5}` : ''}, ${name4}${name5 != '100' ? `${name5}` : ''}); 
                        background: url(${nameCard[i][1]}), -webkit-linear-gradient(right, ${name3}, ${name3}), -webkit-linear-gradient(right, ${name4}${name5 != '100' ? `${name5}` : ''}, ${name4}${name5 != '100' ? `${name5}` : ''}); 
                        background: url(${nameCard[i][1]}), -o-linear-gradient(right, ${name3}, ${name3}), -o-linear-gradient(right, ${name4}${name5 != '100' ? `${name5}` : ''}, ${name4}${name5 != '100' ? `${name5}` : ''}); 
                        background: url(${nameCard[i][1]}), -moz-linear-gradient(right, ${name3}, ${name3}), -moz-linear-gradient(right, ${name4}${name5 != '100' ? `${name5}` : ''}, ${name4}${name5 != '100' ? `${name5}` : ''}); 
                        background: url(${nameCard[i][1]}), -ms-linear-gradient(right, ${name3}, ${name3}), -ms-linear-gradient(right, ${name4}${name5 != '100' ? `${name5}` : ''}, ${name4}${name5 != '100' ? `${name5}` : ''});
                    }  
                    `;
                }
            }
            return linkCode
        },function modcontentfunc(nameCard) {
            let linkCode = ``;
        
            for(let i = 0; i < nameCard.length; i++){
                if(nameCard[i][0] != ''){
                    linkCode += `
                    [name="${nameCard[i][0]}"] { background-image: url(${nameCard[i][1]}); }
                    `;
                }
            }
            return linkCode
        ...
        ${name[1] == '0' ?  `
            <style> 
                ${nolimBlocks[i].modoptions[0](name[6])}
                .styleInput::placeholder{background-repeat: no-repeat; background-size: 24px; line-height:24;  padding: ${name[0] == 'left' ? '0 20px 0 42px' : '0px'} !important; background-position: ${name[0]} 0px center;  background-origin: padding-box; }
            
            </style> 
        ` : name[1] == '1' && name[3][1] != '' ? `
            <style> 
                ${name[3][2] == '0' ? `
                    ${nolimBlocks[i].modoptions[2](name[6],name[3][1])}
                ` : `
                    ${nolimBlocks[i].modoptions[3](name[6],name[3][1],name[4],name[5])}
                `}
                .styleInput{
                    background-size: 24px, ${name[3][0]} 100%, ${name[2] == '20px' ? '65px' : name[2] == '18px' ? '61px' : name[2] == '15px' ? '55px' : name[2] == '12px' ? '48px' : '45px'} 100%; background-repeat: no-repeat; 
                    padding: ${name[0] == 'left' ? (name[2] == '20px' ? '0 20px 0 85px' : name[2] == '18px' ? '0 20px 0 76px' : name[2] == '15px' ? '0 20px 0 71px' : name[2] == '12px' ? '0 20px 0 65px' : '0 20px 0 60px') : (name[2] == '20px' ? '0 85px 0 20px' : name[2] == '18px' ? '0 76px 0 20px' : name[2] == '15px' ? '0 71px 0 20px' : name[2] == '12px' ? '0 65px 0 20px' : '0 60px 0 20px')} !important; 
                    background-position: ${name[0]} ${name[2]} center,${name[0]} ${name[2] == '20px' ? '64px' : name[2] == '18px' ? '60px' : name[2] == '15px' ? '54px' : name[2] == '12px' ? '47px' : '44px'} center, ${name[0] == 'left' ? 'left' : 'right, 0px center'};  
                    background-origin: padding-box; 
                }  
            </style> 
        ` : name[1] == '1' && name[3][1] == '' ? `
            <style>  
                ${nolimBlocks[i].modoptions[4](name[6])}
                .styleInput{background-repeat: no-repeat; background-size: 24px; padding: 0 ${name[0] == 'left' ? (name[2] == '20px' ? '20px 0 65px' : name[2] == '18px' ? '20px 0 61px' : name[2] == '15px' ? '20px 0 55px' : name[2] == '12px' ? '20px 0 48px' : '20px 0 45px') : (name[2] == '20px' ? '65px 0 20px' : name[2] == '18px' ? '61px 0 20px' : name[2] == '15px' ? '55px 0 20px' : name[2] == '12px' ? '48px 0 20px' : '45px 0 20px')} !important; background-position:${name[0]} ${name[2]} center;  background-origin: padding-box; background-position-y: center; }  
            </style>
        ` : ''}
        ...
        $(document).ready(function() {
            let sI = setInterval(function(){
                if($('.t396__artboard').length == $('.t396__artboard.rendered').length){
                    clearInterval();
                    var nameinput = '${nolimBlocks[i].modoptions[1](name[6])}';
                    nameinput = $(nameinput).addClass('styleInput');
                        for (let ig = 0; ig < $(nameinput).length; ig++) {
                            let eg = '#' + $(nameinput).eq(ig).closest('.t-rec').attr('id');
                            $(eg).on('input focusin focusout', function (e) {
                                e.preventDefault();
                                for (let i = 0; i < $(eg + ' :-webkit-autofill').length; i++) {
                                    $(eg + ' :-webkit-autofill').eq(i).val($(eg + ' :-webkit-autofill').eq(i).val());
                                }
                            });
                        }
                    }
...
nolimBlocks.push({
    ...
    <script> 
        ...
        var wload=0, wfirst=${n2i(name[6],'5')}, wfirstp=${n2i(name[5],'40')}, wsec=${n2i(name[9],'3')}, wsecp=${n2i(name[8],'80')}, recid="${n2i(name[0],'#rec000000')}", i=1, gg=0, pt=0, wloadc="${n2i(name[1],'preloadpercent')}"; 
    
        ${typeof name[3][0] != "undefined" && name[3][0] == "" ? `` : `function pretext() { var o="${name[3][1]}", t="${name[3][0]}"; wload<=100&&setTimeout(function() { 0==pt?($("."+t+" .tn-atom").html(o+"."), pt=1):1==pt?($("."+t+" .tn-atom").html(o+".."), pt=2):2==pt&&($("."+t+" .tn-atom").html(o+"..."), pt=0), pretext() } , 400) }`}function myLoop3() { 1 == gg && setTimeout(function() { (wload+=1)>=100&&(wload=100), $("."+wloadc+" .tn-atom").html(wload+"${n2i(name[2],'%')}"), wload<100?myLoop3():($("."+wloadc+" .tn-atom").html("100${n2i(name[2],'%')}"), $(recid).delay(0).fadeOut('slow'), $("body").css("overflow", "auto")) } , 8) };
    
        function myLoop2() { 0 == gg && setTimeout(function() { if (gg == 0) { let o=(wsecp-wfirstp)/wsec; o=o<1?Math.ceil(o):Math.round(o), wload+=o, $("."+wloadc+" .tn-atom").html(wload+"${n2i(name[2],'%')}"), wload<=wsecp&&myLoop2() }; }, 1000) };
    
        function myLoop() { 0 == gg && setTimeout(function() { if (gg == 0) { let o=wfirstp/wfirst; o=o<1?Math.ceil(o):Math.round(o), wload+=o, $("."+wloadc+" .tn-atom").html(wload+"${n2i(name[2],'%')}"), wload<=wfirstp?myLoop():myLoop2() }; }, 1000) };
    
        ${typeof name[3][0] != "undefined" && name[3][0] == "" ? `` : `pretext(),`} myLoop(), $("."+wloadc+" .tn-atom").html(wload+"${n2i(name[2],'%')}"), $(recid).show(), $(document).ready(function() { setTimeout(function() { gg = 1, myLoop3() }, 3000); }); 
        
    </script> 
    
    <style> ${n2i(name[0],'#rec000000')}{position:fixed;left:0;top:0;right:0;bottom:0;z-index:100005} </style>
    `;
    },
    instruction: `<div id="group_bheader" class="pe-form-group__help-content pe-form-group__help-content_top pe-form-group">
    Как это работает:<br><br>
    ...
    nolimBlocks.push({
        ...
        <style> 
            ...
            .${name[1]} .tn-atom:after { content: ''; position: absolute; left: 0; bottom: 20%; opacity: 0; width: 100%; height: 100%; border-bottom: ${name[11] == "2" ? "1" : name[11] == "3" ? "2" : name[11] == "4" ? "3" : name[11] == "5" ? "4" : "0"}px solid ${name[12]}; 
            -webkit-box-shadow: inset 0px ${name[11] == '0' ? '-0' : '-1'}px 0px 0px ${name[12]}; 
            -moz-box-shadow: inset 0px ${name[11] == '0' ? '-0' : '-1'}px 0px 0px ${name[12]}; 
            box-shadow: inset 0px ${name[11] == '0' ? '-0' : '-1'}px 0px 0px ${name[12]}; 
            -webkit-transition: all 0.3s ease; transition: all 0.3s ease; } 
            .${name[1]} .tn-atom.t-active{ color: ${name[3]} !important; font-weight: ${name[4]} !important; opacity: ${name[5]} !important; } 
            .${name[1]} .tn-atom.t-active:after { opacity: 1; bottom: -1px; border-bottom: ${name[6] == "2" ? "1" : name[6] == "3" ? "2" : name[6] == "4" ? "3" : name[6] == "5" ? "4" : "0"}px solid ${name[7]}; 
            -webkit-box-shadow: inset 0px ${name[6] == '0' ? '-0' : '-1'}px 0px 0px ${name[7]}; 
            -moz-box-shadow: inset 0px ${name[6] == '0' ? '-0' : '-1'}px 0px 0px ${name[7]}; 
            box-shadow: inset 0px ${name[6] == '0' ? '-0' : '-1'}px 0px 0px ${name[7]}; } 
            .${name[1]} .tn-atom:not(.t-active):not(.tooltipstered):hover { color: ${name[9]} !important; opacity: ${name[10]}; } 
        ...
        nolimBlocks.push({
            ...
            modcontent: function modcontentfunc(name) {
                ...
                ${name[3] == '0' ? `
                    ${name[0]} .t396:before {
                        content:'';
                        background-color: ${name[4]}${name[5] != '100' ? `${name[5]}` : ''};
                        position: fixed;
                        width: 110%;
                        height: 110%;
                    }
            ...
            nolimBlocks.push({
                ...
                id: "131",
                inlib: "y",
                filter: "Популярные, Прочее, Кнопки",
...
nolimBlocks.push({
    ...
    <script> 
    $(document).ready(function() { var o = "${name[0]}"; $('[href="${name[2]}"]').click(function() { 
        ...
        var funcZeroSuccess = function($form) { $("${name[0]}").fadeIn(), $('.t-body').addClass('nolimPopUp'); $("${name[0]}").css("overflow", "auto"), "y" === window.lazy && t_lazyload_update(), $("${name[1]} .t706").hide(), $('.t-form-success-popup').hide(); let unlockScr = setInterval((function () { if ($('.t-body_scroll-locked').length > 0) { clearInterval(unlockScr); window.tildaForm.unlockBodyScroll(); } }), 50); setTimeout(function() { $('${name[1]} .t-popup__close').trigger('click'); $('.nolim_popup_close').click(); }, 100); $('${name[1]} .js-successbox').hide(); $('${name[1]} .t653 .js-successbox').show(); typeof t_slds_updateSlider != "undefined" && t_slds_updateSlider('${name[0].replace('#rec','')}'); t396_doResize('${name[0].replace('#rec','')}'); };
    ...
    <style> 
        ${name[0]} .t396__filter{cursor:pointer}
        ${name[0]}{display:none;position:fixed;left:0;top:0;right:0;bottom:0;z-index:100005; overflow: auto;} 
        ${name[1]} .t281__input-wrapper, ${name[1]} .t274__wrapper{ opacity: 1 !important; max-height: unset !important; }
        ${name[3] == '0' ? `${name[0]} .t396:before{ content: ''; background-color: ${name[4]}${name[5] != '100' ? `${name[5]}` : ''}; position: fixed; width: 110%; height: 110%; }` : ''}
...
nolimBlocks.push({
    name: "",
    cod: "NLM065",
    filter: "Меню, Корзина и товары",
    descr: "",
    descr_ru: "",
    disableforplan0: "y",
    icon: "https://static.tildacdn.com/tild3664-3462-4364-b535-343136323361/NLM065.svg",
    icon2: "/files/tplsthumbs/other-block-02.png",
    id: "131",
    inlib: "y",
    ...
    <style> 
        ...
        ${name[4] == "0" ? "" : "@media screen and (min-width: 980px) {"}
        .t1002__wishlisticon {
            display: none;
        }
    ...
    <script> 
    $(document).ready(function(){
        $('[href="${name[0]}"]').click(function(e){
            e.preventDefault();
            if (window.twishlist.total > 0){
                twishlist__openCart();
            } ${typeof name[2] != "undefined" && name[2] != '' ? `else{
                $('[href="${name[2]}"]')[0].click();
            }` : ''}
        });
        ${name[3] == '0' ? `$('.${name[1]}').hide();` : `$('.${name[1]}').css('display', 'table');`}
        $(".t1002").on('DOMSubtreeModified', ".t1002__wishlisticon-counter", function() {
            let nlcountz = window.twishlist.total;
            $('.${name[1]} .tn-atom').html(nlcountz);
            if (nlcountz == 0) { ${name[3] == '0' ? `$('.${name[1]}').hide();` : ''} ${name[2] == '' ? `$('[href="${name[0]}"]').parent().css('pointer-events', 'none');` : ''} 
            } else{
                $('[href="${name[0]}"]').parent().css('pointer-events', 'all');
                ${name[3] == '0' ? `$('.${name[1]}').css('display', 'table');` : ''}
            }
            $('[href="${name[0]}"]').addClass('cartcopyanim2');
            setTimeout(function () {
                $('[href="${name[0]}"]').removeClass('cartcopyanim2');
            }, 600);
        });
        setTimeout(function () {
            $('#cartcopyanim2${name[1]}').remove();
        }, 1200);
    }); 
    </script> 
    
    <style id="cartcopyanim2${name[1]}"> 
        .cartcopyanim2 { 
            -webkit-animation: unset!important; 
            animation: unset!important; 
        } 
    </style> 
    ${typeof name[2] != "undefined" && name[2] != '' ? `<a href="${name[2]}" style="display:none"></a>` : ''}
...
descr_ru: "",
disableforplan0: "y",
icon: "https://static.tildacdn.com/tild3663-3766-4831-b736-313565656437/NLM067.svg",
icon2: "/files/tplsthumbs/other-block-02.png",
id: "131",
inlib: "y",
filter: "Эффекты",
...
instruction: `<div id="group_bheader" class="pe-form-group__help-content pe-form-group__help-content_top pe-form-group">
1. Добавляем шейп в Зеро Блок и указываем класс к нему такой же как и в модификации;<br><br>

Что бы указать класс у элемента, нажимаешь на него правой кнопкой мыши и выбираем из списка последнюю строку "Add CSS Class Name", далее, справа в настройках указываем тот же класс, что и в модификации;<br><br>

2. Настройте параметры эффекта (ширина, цвета и скорость вращения);<br><br>

3. Настройте параметры эффекта при наведении;<br><br>
...
descr_ru: "",
disableforplan0: "y",
icon: "https://static.tildacdn.com/tild3962-3562-4531-b635-633766346439/NLM068.svg",
icon2: "/files/tplsthumbs/other-block-02.png",
id: "131",
inlib: "y",
filter: "Популярные, Меню",
...
<script> 
    $(document).ready(function() { 
        ...
        let sI = setInterval(function() { 
            if ($('.${name[0]} .tn-atom').length > 0) { 
                clearInterval(sI); 
                var menu2 = menus; 
                var href = $('.${name[0]} a'); 
                var idM = $('.${name[0]} .tn-atom').parents('.t-rec'); 
                var idMh = $('.${name[0]} .tn-atom').parents('.t-rec').children().children().css('height'); 
                var idPos = $('.${name[0]} .tn-atom').parents('.t-rec').css('position'); 
                ...
                setTimeout(function(){ 
                    href.off('click').on('click', function(e) { 
                        ...
                        if ($(id).css('display') == 'none') { 
                            $(menu2).${name[2] == "0" ? 'slideUp()' : 'fadeOut()'}; 
                            $(id).${name[2] == "0" ? 'slideDown()' : 'fadeIn()'}; 
                        } else { 
                            $(id).${name[2] == "0" ? 'slideUp()' : 'fadeOut()'} 
                        }; 
                    }); 
                },600);

                ${name[1] == "0" ? "href.mouseover(function(e) { e.preventDefault(); let id = $(e.currentTarget).attr('href'); if ($(id).css('display') == 'none') { $(menu2)." + (name[2] == "0" ? "slideUp()" : "fadeOut()") + "; $(id)." + (name[2] == "0" ? "slideDown()" : "fadeIn()") + "}; });" : ""} 
                
                $(document).on('${name[1] == "0" ? 'pointermove mousemove' : 'pointerup mouseup'}', (function(e) { 
...
&bull; Отступ для меню будет выставлен автоматически;<br>
&bull; Модификация работает совместно с модификациями поиска и фиксацией Зеро блока от Нолим;</b><br><br>

1. Добавляем кнопку в Зеро Блок и указываем класс к нему такой же как и в модификации;<br><br>

Что бы указать класс у элемента, нажимаешь на него правой кнопкой мыши и выбираем из списка последнюю строку "Add CSS Class Name", далее, справа в настройках указываем тот же класс, что и в модификации;<br><br>

&bull; Кнопка может быть сделана из текста, шейпа, кнопки или картинки;<br>
&bull; Внутри этой кнопки ссылкой укажите id блока, который будет выполнять роль меню;<br>
&bull; Повторите для нескольких пунктов(и соответственно меню) если нужно;<br>

2. Выбираем показывать ли меню при наведении или по клику;<br>

3. Выбираем анимацию показа меню;<br>
...
descr_ru: "",
disableforplan0: "y",
icon: "https://static.tildacdn.com/tild3162-3065-4336-b334-346637306362/NLM069.svg",
icon2: "/files/tplsthumbs/other-block-02.png",
id: "131",
inlib: "y",
filter: "Меню",
title: "Выпадающий «Поиск» в стандартное меню",
modsettings: `[
{
    "id": "1",
...
instruction: `<div id="group_bheader" class="pe-form-group__help-content pe-form-group__help-content_top pe-form-group">
<b>Работает в блоках меню - me301, me302, me303, me303А, me203a<br><br>

1. Выбираем блок или вписываем id блока с поиском T838;<br><br>

2. Выбираем размер иконки поиска;<br><br>

3. Загружаем свою иконку поиска;<br><br>

4. Вписываем ссылку в модификацию на соцсеть, мессенджер или любой другой сервис, который имеет ссылку;
- Эту же ссылку вставляем в меню на любую соц. сеть;

5. Выбираем анимацию показа блока с поиском;
...
descr_ru: "",
disableforplan0: "y",
icon: "https://static.tildacdn.com/tild6661-3930-4461-b630-623939393763/NLM070.svg",
icon2: "/files/tplsthumbs/other-block-02.png",
id: "131",
inlib: "y",
filter: "Текст, Эффекты",
title: "Текст со скроллом в Zero Block",
modsettings: `[
{
    "id": "1",
    "title": "Class текста",
...
1. Вписываем класс в модификацию. Такой же ставим текстовому элементу в Zero Block;<br><br>

2. Вписываем высоту текстового блока, которая будет на опубликованной странице;<br><br>

3. Вписываем ширину скроллбара(ползунок прокрутки);<br><br>

4. Вписываем цвет скроллбара;<br><br>

5. Вписываем BORDER-RADIUS ползунка;<br><br>

6. Вписываем толщину BORDER ползунка;<br><br>

7. Вписываем цвет BORDER ползунка;<br><br>

8. Вписываем цвет ЦВЕТ ФОНА у ползунка;<br><br>

9. Нажимаем кнопку "Сохранить и закрыть"<br><br>
</div>`
